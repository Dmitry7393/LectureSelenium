...
#include "../../../../../../../src/Test/DragableWidget.h"
...
static const char qt_meta_stringdata_DragableWidget[] = {
    "DragableWidget\0"
};
...
const QMetaObjectExtraData DragableWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DragableWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DragableWidget,
      qt_meta_data_DragableWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DragableWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DragableWidget))
